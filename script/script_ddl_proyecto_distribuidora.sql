...
(
  ...
  CONSTRAINT ck_familia_tipos CHECK (descripcion IN('Comidas', 'Bebidas', 'Lácteos', 'Higiene Personal', 'Bebidas alcohólicas', 'Cuidado Doméstico', 'Pilas, Velas, Encendedores'))
);
